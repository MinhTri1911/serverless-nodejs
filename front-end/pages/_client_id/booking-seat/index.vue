            ...
            <div id="SingleContents">
                <div class="d-flex flex-md-row flex-column justify-content-between w-100">
                    <div class="w-md-50 w-100">
                        <div id="InfoContents">
                            ...
                            <!--Info Ticket-->
                            <TicketInfo :seat-type="true" :dataTicket="dataTicket" ></TicketInfo>
                            <!--Info Ticket End-->
                        </div>

                        <div id="TicketContent">
                            <!--Ticket Type-->
                            <TicketContentSeat :seats="dataSeatType.seats"></TicketContentSeat>
                            <!--Ticket Type End-->
                        </div>
                    </div>
                ...
                <div id="Pagination">
                    <div class="d-flex justify-content-between">
                        <button class="btn" @click="onBackBtn">
                            {{ $t("booking.btn_back")}}
                        </button>
...
<script src="@/business/booking/BookingSeatBusiness.js"></script>
<style lang="scss">
